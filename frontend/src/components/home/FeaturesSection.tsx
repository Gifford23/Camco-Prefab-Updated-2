...
const features = [
  {
    ...
    description:
      "Experience complete price certainty with our innovative construction approach. Our factory-controlled manufacturing eliminates costly overruns, reduces material waste by up to 70%, and accelerates timelines by 50%, delivering exceptional value and faster ROI for your investment.",
    stats: [
  ...
  },
  {
    ...
    description:
      "Combining structural excellence with unlimited design possibilities. Every unit undergoes rigorous quality control in our climate-controlled facility, ensuring precision engineering and durability that surpasses traditional construction methods.",
    stats: [
  ...
  },
  {
    ...
    description:
      "Building a greener future through responsible construction. By upcycling shipping containers and optimizing our manufacturing process, we reduce material waste by 70% and deliver energy-efficient designs that lower your carbon footprint and utility costs.",
    stats: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20">
          ...
          <p className="text-xl text-slate-600 leading-relaxed max-w-3xl mx-auto">
            We deliver end-to-end prefabricated construction solutions that
            combine innovation, quality, and sustainability to exceed your
            ...
            >
              ...
              <div className="p-8">
                ...
                <div className="relative mb-6">
                  <div
                    className={`absolute inset-0 ${feature.lightBg} rounded-2xl blur-xl opacity-50 group-hover:opacity-70 transition-opacity`}
                  ></div>
                  <div
                    className={`relative w-20 h-20 bg-gradient-to-br ${feature.gradient} rounded-2xl flex items-center justify-center text-white shadow-lg transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}
                  >
                    {feature.icon}
                  </div>
                </div>
              ...
              <div
                className={`absolute -bottom-10 -right-10 w-32 h-32 bg-gradient-to-br ${feature.gradient} rounded-full opacity-5 group-hover:opacity-10 transition-opacity`}
              ></div>
            </div>
          ))}
        </div>
