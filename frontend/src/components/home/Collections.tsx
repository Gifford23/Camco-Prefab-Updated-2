...
import { ArrowRight, Star, Zap, Eye, Heart, ShoppingCart, X, Check, Package, Shield, Clock, Award } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogHeader,
  ...
  const callouts = [
    {
      ...
      description:
        "Premium modular container solutions for modern living and commercial spaces",
      imageSrc:
        "https://camcoprefabricatedstructures.com/wp-content/uploads/2024/10/Lorem-ipsun-8.gif",
    ...
    },
    {
      ...
      description:
        "Luxury portable housing with premium finishes and modern amenities",
      imageSrc:
        "https://camcoprefabricatedstructures.com/wp-content/uploads/2024/10/Lorem-ipsun-5.gif",
      ...
      features: [
        ...
        "Water and sewage ready",
        "Luxury furnishing options"
      ]
    },
    {
      id: 3,
      ...
      description:
        "High-quality sanitation solutions with advanced features and durability",
      imageSrc:
        "https://camcoprefabricatedstructures.com/wp-content/uploads/2024/10/Lorem-ipsun-7.gif",
  ...
  return (
    <section className="relative py-24 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-10 right-10 w-96 h-96 bg-purple-200 opacity-20 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/4 w-64 h-64 bg-emerald-200 opacity-25 rounded-full blur-3xl animate-pulse"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
            Discover our premium collection of innovative prefabricated
            structures, designed for modern living and built to exceed
            expectations
          </p>
            ...
            >
              ...
              <div className="relative bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100">
                ...
                <div className="relative overflow-hidden rounded-t-3xl">
                  ...
                  {/* Image Overlay */}
                  <div
                    className="absolute inset-0 bg-gradient-to-t from-black opacity-0 group-hover:opacity-50 transition-opacity duration-300"
                    style={{
                      background:
                  ...
                  <div className="absolute top-4 right-4 flex space-x-2">
                    ...
                    <button
                      className="w-10 h-10 bg-white bg-opacity-90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300 hover:bg-white"
        ...
        >
          <div className="bg-white bg-opacity-80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-gray-100 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              Need something specific? Our expert team can create custom prefab
