...
const ContractDetail = () => {
  ...
  const handleDownloadDocx = async () => {
    try {
      ...
      if (!editedContent || editedContent.trim() === '') {
        toast.error("Contract content is still loading. Please wait a moment and try again.");
        return;
      }
  ...
  const handlePrint = () => {
    if (!editedContent || editedContent.trim() === '') {
      toast.error("No contract content to print. Please wait for the content to load.");
      return;
    }
